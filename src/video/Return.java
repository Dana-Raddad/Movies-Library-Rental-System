...
Connection getcon() throws ClassNotFoundException, SQLException{
 ...
 public  void doo() throws ClassNotFoundException, SQLException{
    ...
    String Q1="select * from vedio where customer = '"+s1+"' and vedio_name = '"+s2+"';";
    ...
    if(rs.next()==false)
        JOptionPane.showMessageDialog(null,"this customer or vedio name does not exist");
    else{
    //while(rs.next()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Return a video");
    ...
    private void JoptionPan(String this_name_does_not_exist) {
